  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route element={<LogisticsManagementSystemPage />} path="/projects/logistics-management-system" />
        <Route element={<EmotionDetectionProjectPage />} path="/projects/emotion-detection" />
        <Route element={<LicensePlateRecognitionPage />} path="/projects/license-plate-recognition" /> {/* Add License Plate route */}
