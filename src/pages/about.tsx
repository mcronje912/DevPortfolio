            ...
            <div className="w-full md:w-1/3">
              ...
              <Card className="mb-6 overflow-hidden">
                <CardBody className="p-5">
                  ...
                  <p className="mb-2 text-default-700">Certificate in Media Design Technology, Damelin (2003-2004)</p>
                  <div className="mt-4">
            ...
            <div className="w-full md:w-2/3">
              ...
              <div className="prose max-w-none mb-8">
                ...
                <div>
                  ...
                  <p className="mb-4">
                    I&apos;m comfortable working throughout the entire development stack—from crafting intuitive user interfaces to implementing efficient backend systems and database architectures. This versatility allows me to approach projects holistically and select the right technologies for each specific challenge.
                  </p>
                </div>
                ...
                <p className="mb-2">
                  My approach centers on creating practical solutions for real business problems, leveraging modern tools and technologies—including AI assistants for rapid prototyping and troubleshooting—to deliver high-quality results efficiently.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="bg-cerulean-50 dark:bg-cerulean-900/30 p-4 rounded-lg">
                    <h3 className="font-medium mb-1 text-cerulean">Problem-First Thinking</h3>
                    <p className="text-sm">Understanding challenges thoroughly before developing solutions</p>
                  </div>
                  <div className="bg-cerulean-50 dark:bg-cerulean-900/30 p-4 rounded-lg">
                    <h3 className="font-medium mb-1 text-cerulean">User-Centered Design</h3>
                    <p className="text-sm">Creating systems that prioritize intuitive user experiences</p>
                  </div>
                  <div className="bg-cerulean-50 dark:bg-cerulean-900/30 p-4 rounded-lg">
                    <h3 className="font-medium mb-1 text-cerulean">Clean, Maintainable Code</h3>
                    <p className="text-sm">Building well-organized architectures with clear documentation</p>
                  </div>
                  <div className="bg-cerulean-50 dark:bg-cerulean-900/30 p-4 rounded-lg">
                    <h3 className="font-medium mb-1 text-cerulean">Practical, Solution-Driven Approach</h3>
                    <p className="text-sm">Creating systems that directly address business needs and deliver tangible improvements</p>
                  </div>
                </div>
                ...
                <p className="mb-6">
                  While primarily focused on full-stack development with Flutter, React, and cloud databases, I also work with Python for specialized integrations and custom business tools. I enhance my productivity by incorporating AI-assisted development practices, which helps me rapidly explore solution options and optimize implementations.
                </p>
