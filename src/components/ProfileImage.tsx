...
export const ProfileImage: React.FC<ProfileImageProps> = ({ 
  ...
  return (
    <div className={`relative overflow-hidden ${sizeClasses} ${shapeClasses} ${className}`}>
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-cerulean to-verdigris opacity-20"></div>
